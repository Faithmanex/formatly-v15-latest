...
export function RegisterForm() {
  ...
  return (
    <div className="flex min-h-screen bg-background text-foreground overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col h-full justify-center">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-bold tracking-tight text-white leading-tight">
              Scale your <span className="text-primary italic">productivity.</span>
            </h2>
            <p className="text-lg text-zinc-400 leading-relaxed font-light">
              Experience the future of document management. One account, total control over your compliance and
              formatting standards.
            </p>

            <div className="grid grid-cols-2 gap-6 pt-4">
              {[
                { label: "Free", desc: "Forever Plan" },
                { label: "100+", desc: "Style Guides" },
                { label: "Zero", desc: "Manual Work" },
                { label: "256-bit", desc: "AES Encryption" },
              ].map((item, idx) => (
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center px-6 sm:px-12 py-12 relative h-full overflow-y-auto">
          ...
          <div className="grid gap-6">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-background px-4 text-muted-foreground font-medium">Or use your email</span>
              </div>
            </div>
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              <div className="space-y-4">
                <div className="space-y-2 group">
                  ...
                  <div className="relative">
                    <div
                      className={`absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground transition-colors ${isFocused.fullName ? "text-primary" : ""}`}
                    >
                      ...
                      <div className="flex items-center justify-between px-1">
                        ...
                        <span
                          className={`text-[10px] font-bold uppercase ${
                            passwordStrength < 40 ? "text-destructive" : passwordStrength < 70 ? "text-yellow-500" : "text-green-500"
                          }`}
                        >
                ...
                <div className="flex bg-muted/30 p-4 rounded-xl items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground leading-relaxed">
                      We never sell your data. Documents are processed in isolated environments.
                    </p>
                  </div>
                </div>
              </div>
